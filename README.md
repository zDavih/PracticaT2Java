...
# CONSULTAS DE LAS ENTRADAS DE UN EVENTO
...
![Captura de pantalla 2024-11-14 204753](https://github.com/user-attachments/assets/fd999538-1b49-48dd-b880-b5917712cdd7)

    * En el caso de que la opción seleccionada sea "Entradas vendidas", nos saldrán tres líneas de texto con la cantidad de entradas que se han vendido de cada tipo asiento: 
![Captura de pantalla 2024-11-14 205130](https://github.com/user-attachments/assets/393d3cc9-0aae-463a-85b4-dbecbeabe170)

    * En el caso de que la opción seleccionada sea "Entradas libres2, nos saldrán tres líneas de texto con la cantidad de entradas que aún quedan libros de cada tipo asiento:
![Captura de pantalla 2024-11-14 205312](https://github.com/user-attachments/assets/50fc977b-845f-4fdb-9ebb-c90505618aac)

    * En el caso de que la opción seleccionada sea "Dias restantes y período de descuento", te pedirá que introduzcas la fecha de hoy con un formato en específico, una vez introducida nos dirá cuanto tiempo queda para el evento (del que previamente hayamos seleccionado9 y si estamos en período de descuento.
![Captura de pantalla 2024-11-14 205526](https://github.com/user-attachments/assets/6cd59977-af8d-4ee6-8170-2e8681c93dc5)

    * Por último la opción d, nos sacará del menú de consultas:    
![Captura de pantalla 2024-11-14 205748](https://github.com/user-attachments/assets/bc26c455-6e9b-4bbb-8929-7fd8e08e5d61)
![Captura de pantalla 2024-11-14 205753](https://github.com/user-attachments/assets/5c008113-4b21-4dbe-a54d-73e5f78dca3b)

# MENÚ DE ADMINISTRADOR
Una vez estemos en esta opción, el menú de administrador estará compuesto por tres opciones que a continuación se explicarán pero antes para poder acceder deberás introducir un usuario y una contraseña, si los usuarios y la contraseña son correctas podrás acceder sino no te dejará.

![Captura de pantalla 2024-11-14 210108](https://github.com/user-attachments/assets/a5e2999a-a8a7-4aab-a134-4e4cf8da3710)

    * El menú de administrador está compuesto de tres opciones:
      a. Consulta de los ingresos totales de un evento
      b. Consulta de las monedas restantes para el cambio
      c. Salir al menú principal
      d. Apagado del software
# CONSULTA DE LOS INGRESOS TOTALES DE UN EVENTO
    * En caso de que se seleccione esta opción empezarán a salir los ingresos totales de cada tipo de evento, en el texto se indica la cantidad exacta de ganancias y deberás pulsar una tecla para que vay saliendo cada evento:
![Captura de pantalla 2024-11-14 210637](https://github.com/user-attachments/assets/d881691b-622d-483f-ba98-e594ed7e9fb7)
# CONSULTA DE LAS MONEDAS RESTANTES PARA EL CAMBIO
    * En caso de que se seleccione esta opción saldrá una tabla la cuál especificará por cada billete y cada moneda, cuantos billetes quedan y cuantas moneds quedan:
![Captura de pantalla 2024-11-14 210843](https://github.com/user-attachments/assets/f2a77993-5167-4303-914f-075015ed4302)
# SALIR AL MENÚ PRINCIPAL
    * En caso de que se seleccione esta opción saldrá un mensaje de "Saliendo al menú..." y nos llevará al menú principal:
![Captura de pantalla 2024-11-14 211023](https://github.com/user-attachments/assets/9dd685cb-507e-4c07-af17-499c13501509)
# APAGADO DEL SOFTWARE
    * En caso de que se seleccione esta opción se producirá una cuenta regresiva en la que una vez llegue a su fin el software habrá finalizado y por lo tanto estará apagado:
![Captura de pantalla 2024-11-14 211023](https://github.com/user-attachments/assets/5c2eeede-a53e-4418-be5a-5ee6fbfaae56)  
